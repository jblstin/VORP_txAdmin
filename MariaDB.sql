...
CREATE TABLE `bank_users` (
  ...
  `money` DECIMAL(22,2) DEFAULT 0.00,
  `gold` DECIMAL(22,2) DEFAULT 0.00,
  `items` longtext DEFAULT NULL,
  `invspace` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
  INDEX `bankusers_idx` (`identifier`) USING BTREE,
  CONSTRAINT `bankusers_fk` FOREIGN KEY (`identifier`) REFERENCES `users` (`identifier`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `characters` (
  ...
  `gold` DECIMAL(11, 2) DEFAULT 0.00,
  `rol` DECIMAL(11, 2) NOT NULL DEFAULT 0.00,
  `xp` INT(11) DEFAULT 0,
  ...
  `gunsmith` DECIMAL(11, 2) DEFAULT 0.00,
  `ammo` longtext COLLATE utf8mb4_bin DEFAULT NULL,
  `discordid` VARCHAR(255) COLLATE utf8mb4_bin DEFAULT '0',
  `lastjoined` longtext COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE  `character_inventories` (
  ...
  `item_name` VARCHAR(50) COLLATE utf8mb4_bin DEFAULT 'item',
  `amount` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `degradation` INT(11) NULL DEFAULT NULL,
  `percentage` INT(11) NULL DEFAULT NULL,
  PRIMARY KEY (`character_id`, `inventory_type`, `item_crafted_id`),
...
CREATE TABLE `items` (
	...
	`desc` VARCHAR(5550) NOT NULL DEFAULT 'nice item' COLLATE utf8mb4_bin,
...
CREATE TABLE  `loadout` (
  ...
  `dirtlevel` DECIMAL(10,2) DEFAULT 0,
  `mudlevel` DECIMAL(10,2) DEFAULT 0,
  `conditionlevel` DECIMAL(10,2) DEFAULT 0,
  `rustlevel` DECIMAL(10,2) DEFAULT 0,
  ...
  `serial_number` VARCHAR(50) NULL DEFAULT NULL COLLATE utf8mb4_bin,
  `custom_label` VARCHAR(50) NULL DEFAULT NULL COLLATE utf8mb4_bin,
  `custom_desc` VARCHAR(50) NULL DEFAULT NULL COLLATE utf8mb4_bin,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE `stables` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `charidentifier` int(11) NOT NULL,
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `modelname` varchar(70) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `gear` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
('dbcandle', 'Dbl Candle', 20, 1, 'item_standard', 1, '{}', 'A DECIMAL(10,2)-sided candle with two wicks.'),
...
('fancydouble', 'Fancy DECIMAL(10,2)', 20, 1, 'item_standard', 1, '{}', 'A stylish and well-crafted DECIMAL(10,2)-barreled firearm.'),
